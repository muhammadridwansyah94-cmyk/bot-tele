...
# ===== COUNTRY MAP ISO 2 HURUF + EMOJI =====
country_map = {
    "1": ("US", "🇺🇸"), "1242": ("BS", "🇧🇸"), "1246": ("BB", "🇧🇧"), "1264": ("AI", "🇦🇮"),
    "1268": ("AG", "🇦🇬"), "1284": ("VG", "🇻🇬"), "1340": ("VI", "🇻🇮"), "1345": ("KY", "🇰🇾"),
    "1441": ("BM", "🇧🇲"), "1473": ("GD", "🇬🇩"), "1649": ("TC", "🇹🇨"), "1658": ("JM", "🇯🇲"),
    "1664": ("MS", "🇲🇸"), "1670": ("MP", "🇲🇵"), "1671": ("GU", "🇬🇺"), "1684": ("AS", "🇦🇸"),
    "1721": ("SX", "🇸🇽"), "1758": ("LC", "🇱🇨"), "1767": ("DM", "🇩🇲"), "1784": ("VC", "🇻🇨"),
    "1787": ("PR", "🇵🇷"), "1809": ("DO", "🇩🇴"), "1829": ("DO", "🇩🇴"), "1849": ("DO", "🇩🇴"),
    "1868": ("TT", "🇹🇹"), "1869": ("KN", "🇰🇳"), "1876": ("JM", "🇯🇲"), "1907": ("US", "🇺🇸"),
    "1939": ("PR", "🇵🇷"), "20": ("EG", "🇪🇬"), "211": ("SS", "🇸🇸"), "212": ("MA", "🇲🇦"),
    ...
    "27": ("ZA", "🇿🇦"), "290": ("SH", "🇸🇭"), "291": ("ER", "🇪🇷"), "297": ("AW", "🇦🇼"),
    "298": ("FO", "🇫🇴"), "299": ("GL", "🇬🇱"), "30": ("GR", "🇬🇷"), "31": ("NL", "🇳🇱"),
    "32": ("BE", "🇧🇪"), "33": ("FR", "🇫🇷"), "34": ("ES", "🇪🇸"), "350": ("GI", "🇬🇮"),
    ...
    "693": ("UM", "🇺🇲"), "694": ("UM", "🇺🇲"), "695": ("🌎", "🌎"), "696": ("PN", "🇵🇳"),
    "697": ("NF", "🇳🇫"), "698": ("CX", "🇨🇽"), "699": ("CC", "🇨🇨"), "7": ("RU", "🇷🇺"),
    "81": ("JP", "🇯🇵"), "82": ("KR", "🇰🇷"), "84": ("VN", "🇻🇳"), "850": ("KP", "🇰🇵"),
    "852": ("HK", "🇭🇰"), "853": ("MO", "🇲🇴"), "855": ("KH", "🇰🇭"), "856": ("LA", "🇱🇦"),
    "86": ("CN", "🇨🇳"), "870": ("🌎", "🌎"), "878": ("🌎", "🌎"), "880": ("BD", "🇧🇩"),
    "886": ("TW", "🇹🇼"), "90": ("TR", "🇹🇷"), "91": ("IN", "🇮🇳"), "92": ("PK", "🇵🇰"),
    "93": ("AF", "🇦🇫"), "94": ("LK", "🇱🇰"), "95": ("MM", "🇲🇲"), "960": ("MV", "🇲🇻"),
    "961": ("LB", "🇱🇧"), "962": ("JO", "🇯🇴"), "963": ("SY", "🇸🇾"), "964": ("IQ", "🇮🇶"),
    "965": ("KW", "🇰🇼"), "966": ("SA", "🇸🇦"), "967": ("YE", "🇾🇪"), "968": ("OM", "🇴🇲"),
    "970": ("PS", "🇵🇸"), "971": ("AE", "🇦🇪"), "972": ("IL", "🇮🇱"), "973": ("BH", "🇧🇭"),
    "974": ("QA", "🇶🇦"), "975": ("BT", "🇧🇹"), "976": ("MN", "🇲🇳"), "977": ("NP", "🇳🇵"),
    "98": ("IR", "🇮🇷"), "992": ("TJ", "🇹🇯"), "993": ("TM", "🇹🇲"), "994": ("AZ", "🇦🇿"),
    "995": ("GE", "🇬🇪"), "996": ("KG", "🇰🇬"), "998": ("UZ", "🇺🇿")
}

# ===== LANG MAP =====
lang_map = {
    "af": "Afrikaans","am": "Amharic","ar": "Arabic","az": "Azerbaijani","be": "Belarusian","bg": "Bulgarian","bn": "Bengali",
    "bs": "Bosnian","ca": "Catalan","cs": "Czech","cy": "Welsh","da": "Danish","de": "German","el": "Greek","en": "English",
    "eo": "Esperanto","es": "Spanish","et": "Estonian","eu": "Basque","fa": "Persian","fi": "Finnish","fr": "French",
    "ga": "Irish","gl": "Galician","gu": "Gujarati","he": "Hebrew","hi": "Hindi","hr": "Croatian","ht": "Haitian Creole",
    "hu": "Hungarian","hy": "Armenian","id": "Indonesian","is": "Icelandic","it": "Italian","ja": "Japanese","jv": "Javanese",
    "ka": "Georgian","kk": "Kazakh","km": "Khmer","kn": "Kannada","ko": "Korean","ku": "Kurdish","ky": "Kyrgyz","la": "Latin",
    "lb": "Luxembourgish","lo": "Lao","lt": "Lithuanian","lv": "Latvian","mg": "Malagasy","mi": "Maori","mk": "Macedonian",
    "ml": "Malayalam","mn": "Mongolian","mr": "Marathi","ms": "Malay","mt": "Maltese","my": "Burmese","ne": "Nepali",
    "nl": "Dutch","no": "Norwegian","pa": "Punjabi","pl": "Polish","ps": "Pashto","pt": "Portuguese","ro": "Romanian",
    "ru": "Russian","sd": "Sindhi","si": "Sinhala","sk": "Slovak","sl": "Slovenian","so": "Somali","sq": "Albanian",
    "sr": "Serbian","su": "Sundanese","sv": "Swedish","sw": "Swahili","ta": "Tamil","te": "Telugu","tg": "Tajik",
    "th": "Thai","tl": "Filipino","tr": "Turkish","uk": "Ukrainian","ur": "Urdu","uz": "Uzbek","vi": "Vietnamese",
    "xh": "Xhosa","yi": "Yiddish","zh-cn": "Chinese (Simplified)","zh-tw": "Chinese (Traditional)","zu": "Zulu"
}
        ...
        for api in API_LIST:
            ...
            while retry > 0:
                try:
                    ...
                    # TIMESMS biasanya data di dalam data["data"]
                    sms_list = data.get("data", data) if isinstance(data, dict) else data

                    for item in sms_list:
                        phone = item.get("num") or item[1]
                        message = item.get("message") or item[2]
                        app_name = item.get("cli") or item[0]
                        time_stamp = item.get("dt") or item[3]
