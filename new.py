...
country_codes = { '1': ('USA/Canada (NANP)', '🇺🇸'),
    ...
    '996': ('Kyrgyzstan', '🇰🇬'),
    '998': ('Uzbekistan', '🇺🇿'),
    # [Isi sama seperti script kamu sebelumnya]
}
...
def generate_sms_id(entry, otp):
    """
    Buat hash unik per SMS untuk anti-double.
    Hanya nomor + OTP -> SMS sama walau timestamp berbeda tetap dianggap duplicate.
    """
