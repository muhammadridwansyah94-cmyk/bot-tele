...
# ------------------ COUNTRY CODES ------------------
country_codes = {
    '1': ('USA/Canada (NANP)', '🇺🇸'), '1242': ('Bahamas', '🇧🇸'), '1246': ('Barbados', '🇧🇧'),
    '1264': ('Anguilla', '🇦🇮'), '1268': ('Antigua & Barbuda', '🇦🇬'), '1284': ('British Virgin Islands', '🇻🇬'),
    '1340': ('U.S. Virgin Islands', '🇻🇮'), '1345': ('Cayman Islands', '🇰🇾'), '1441': ('Bermuda', '🇧🇲'),
    '1473': ('Grenada', '🇬🇩'), '1649': ('Turks & Caicos Is.', '🇹🇨'), '1658': ('Jamaica', '🇯🇲'),
    '1664': ('Montserrat', '🇲🇸'), '1670': ('Northern Mariana Is.', '🇲🇵'), '1671': ('Guam', '🇬🇺'),
    '1684': ('American Samoa', '🇦🇸'), '1721': ('Sint Maarten', '🇸🇽'), '1758': ('Saint Lucia', '🇱🇨'),
    '1767': ('Dominica', '🇩🇲'), '1784': ('St. Vincent & Grenadines', '🇻🇨'), '1787': ('Puerto Rico', '🇵🇷'),
    '1809': ('Dominican Republic', '🇩🇴'), '1829': ('Dominican Republic', '🇩🇴'), '1849': ('Dominican Republic', '🇩🇴'),
    '1868': ('Trinidad & Tobago', '🇹🇹'), '1869': ('Saint Kitts & Nevis', '🇰🇳'), '1876': ('Jamaica', '🇯🇲'),
    '1907': ('Alaska (USA)', '🇺🇸'), '1939': ('Puerto Rico', '🇵🇷'), '20': ('Egypt', '🇪🇬'),
    '211': ('South Sudan', '🇸🇸'), '212': ('Morocco', '🇲🇦'), '213': ('Algeria', '🇩🇿'),
    '216': ('Tunisia', '🇹🇳'), '218': ('Libya', '🇱🇾'), '220': ('Gambia', '🇬🇲'),
    '221': ('Senegal', '🇸🇳'), '222': ('Mauritania', '🇲🇷'), '223': ('Mali', '🇲🇱'),
    '224': ('Guinea', '🇬🇳'), '225': ('Ivory Coast (Côte d\'Ivoire)', '🇨🇮'), '226': ('Burkina Faso', '🇧🇫'),
    ...
    '239': ('São Tomé & Príncipe', '🇸🇹'), '240': ('Equatorial Guinea', '🇬🇶'), '241': ('Gabon', '🇬🇦'), '242': ('Congo (Republic)', '🇨🇬'),
    '243': ('DR Congo (Zaire)', '🇨🇩'), '244': ('Angola', '🇦🇴'), '245': ('Guinea-Bissau', '🇬🇼'), '246': ('Diego Garcia', '🇮🇴'),
    ...
    '260': ('Zambia', '🇿🇲'), '261': ('Madagascar', '🇲🇬'), '262': ('Réunion', '🇷🇪'), '263': ('Zimbabwe', '🇿🇼'),
    '264': ('Namibia', '🇳🇦'), '265': ('Malawi', '🇲🇼'), '266': ('Lesotho', '🇱🇸'), '267': ('Botswana', '🇧🇼'),
    '268': ('Eswatini', '🇸🇿'), '269': ('Comoros', '🇰🇲'), '27': ('South Africa', '🇿🇦'), '290': ('Saint Helena', '🇸🇭'),
    ...
    '387': ('Bosnia & Herzegovina', '🇧🇦'), '389': ('North Macedonia', '🇲🇰'), '39': ('Italy', '🇮🇹'),
    '40': ('Romania', '🇷🇴'), '41': ('Switzerland', '🇨🇭'), '420': ('Czech Republic', '🇨🇿'), '421': ('Slovakia', '🇸🇰'),
    '423': ('Liechtenstein', '🇱🇮'), '43': ('Austria', '🇦🇹'), '44': ('United Kingdom', '🇬🇧'), '45': ('Denmark', '🇩🇰'),
    ...
    '508': ('Saint Pierre & Miquelon', '🇵🇲'), '509': ('Haiti', '🇭🇹'), '51': ('Peru', '🇵🇪'), '52': ('Mexico', '🇲🇽'),
    ...
    '672': ('Australian External Territories', '🇦🇺'), '673': ('Brunei', '🇧🇳'), '674': ('Nauru', '🇳🇷'), '675': ('Papua New Guinea', '🇵🇬'),
    ...
    '693': ('Wake Island', '🇺🇲'), '694': ('Marcus Island', '🇺🇲'), '695': ('Oceanic services (unassigned)', '🌎'),
    '696': ('Pitcairn Islands', '🇵🇳'), '697': ('Norfolk Island', '🇳🇫'), '698': ('Christmas Island', '🇨🇽'), '699': ('Cocos (Keeling) Islands', '🇨🇨'),
    '7': ('Russia/Kazakhstan', '🇷🇺'), '81': ('Japan', '🇯🇵'), '82': ('South Korea', '🇰🇷'), '84': ('Vietnam', '🇻🇳'), '850': ('North Korea', '🇰🇵'),
    '852': ('Hong Kong', '🇭🇰'), '853': ('Macau', '🇲🇴'), '855': ('Cambodia', '🇰🇭'), '856': ('Laos', '🇱🇦'), '86': ('China', '🇨🇳'),
    '870': ('Inmarsat SNAC', '🌎'), '878': ('Universal Personal Telecommunications', '🌎'), '880': ('Bangladesh', '🇧🇩'), '881': ('Global Mobile Satellite (Thuraya, Iridium etc.)', '🌎'),
    '882': ('International Networks', '🌎'), '883': ('International Networks', '🌎'), '886': ('Taiwan', '🇹🇼'), '888': ('Telecommunications for Disaster Relief', '🌎'),
    '89': ('(Reserved)', '🌎'), '90': ('Turkey', '🇹🇷'), '91': ('India', '🇮🇳'), '92': ('Pakistan', '🇵🇰'), '93': ('Afghanistan', '🇦🇫'),
    ...
    '974': ('Qatar', '🇶🇦'), '975': ('Bhutan', '🇧🇹'), '976': ('Mongolia', '🇲🇳'), '977': ('Nepal', '🇳🇵'), '979': ('International Premium Rate Service', '🌎'),
    '98': ('Iran', '🇮🇷'), '991': ('Trial of a proposed new international telecommunication public correspondence service', '🌎'),
