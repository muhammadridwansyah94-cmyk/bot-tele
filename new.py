...
import re
import asyncio  # tambahan untuk async send
...
# Country map (sudah ada)
country_map = {
    "1": ("United States", "🇺🇸"),
    "62": ("Indonesia", "🇮🇩"),
    "91": ("India", "🇮🇳"),
    # ... tambahkan kode negara lain seperti di script lama
}
...
──────────────────────────────"""
        ...
        try:
            # Gunakan asyncio.run() supaya send_message async bisa jalan
